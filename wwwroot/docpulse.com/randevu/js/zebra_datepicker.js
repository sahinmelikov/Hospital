...
*/					
					...
					$(document).bind('focusin', function(e) {
						if($(e.target).attr('id') != $(datepicker).attr('id')) {
							if($(e.target).attr('id') == $(clickables).attr('id')) {
								e.preventDefault();
								if(!$element.attr('disabled')) plugin.show();
							} else {
								plugin.hide();
                ...
                $(document).bind({
                    ...
                    'mousedown.Zebra_DatePicker': function(e) {
                        ...
                        if (datepicker.hasClass('dp_visible')) {
                            ...
                            // hide the date picker
                            // if ($(e.target).parents().filter('.Zebra_DatePicker').length === 0) plugin.hide(); // ahmet
                    ...
                    'keyup.Zebra_DatePicker': function(e) {
                        ...
                        // hide the date picker
                        // if (datepicker.hasClass('dp_visible') && e.which == 27) plugin.hide(); // ahmet
